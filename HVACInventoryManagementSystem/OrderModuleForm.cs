...
namespace HVACInventoryManagementSystem
{
    public partial class OrderModuleForm : Form
    {
        ...
        public void LoadProduct()
        {
            ...
            cm = new SqlCommand("SELECT * FROM tbProduct WHERE CONCAT(pid,pname,pcategory,pmodelno,pstatus,pwarehouse) LIKE '%" + txtSearchProd.Text + "%' ", con);
            con.Open();
            dr = cm.ExecuteReader();
            while (dr.Read())
            {
        ...
        private void dgvProduct_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtPrice.Text = dgvProduct.Rows[e.RowIndex].Cells[7].Value.ToString();
        }
